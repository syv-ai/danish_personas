...
| Synthetic biography mistaken for source data | The generation-4 persona preserves source-backed broad facts while prompts explicitly define names, detailed education, workplace setting, relationships, family, interests, and ambitions as fictional elaboration. Surnames, real employers or institutions, exact addresses, former work, and appearance remain prohibited. | Readers may still mistake plausible fictional details for observed Statistics Denmark data, so dataset documentation and blinded review remain mandatory |
...
| Unauthorised LLM execution                  | The root Hydra config defaults to a local endpoint; invocations have row and HTTP-request caps, and credentials must come from an environment variable                                                                                                                                                                                                                                                                                                                                                                                                       | A user with repository and provider access can deliberately enable bounded calls                                                                              |
