...
| Sensitive-attribute inference | Prompts prohibit inference; versioned validators reject configured health, religion, sexuality, ethnicity, and political terms. FOLK2 remains an aggregate audit-only marginal and is not emitted or sent to LLMs. | A finite term list has false negatives; any future origin sampling requires a separate privacy review and human review remains mandatory |
...
FOLK2's official IELAND categories are retained only as a national independent marginal;
they are not treated as ethnicity or citizenship. They are not yet sampled or emitted, and
any future use requires a separate sampling and privacy review.
